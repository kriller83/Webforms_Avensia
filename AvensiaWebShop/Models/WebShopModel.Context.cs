...
namespace AvensiaWebShop.Models
{
    ...
    public partial class AvensiaWebshopEntities : DbContext
    {
        public AvensiaWebshopEntities()
            : base("name=AvensiaWebshopEntities")
        {
        }
        ...
        public virtual DbSet<vProductAndDescripttionExtendedENOnly> vProductAndDescripttionExtendedENOnly { get; set; }
        public virtual DbSet<vProductCategoryWithDescription> vProductCategoryWithDescription { get; set; }
        ...
        [DbFunction("AvensiaWebshopEntities", "ufnGetAllCategories")]
        public virtual IQueryable<ufnGetAllCategories_Result> ufnGetAllCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetAllCategories_Result>("[AvensiaWebshopEntities].[ufnGetAllCategories]()");
        }
    
        [DbFunction("AvensiaWebshopEntities", "ufnGetCustomerInformation")]
        public virtual IQueryable<ufnGetCustomerInformation_Result> ufnGetCustomerInformation(Nullable<int> customerID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetCustomerInformation_Result>("[AvensiaWebshopEntities].[ufnGetCustomerInformation](@CustomerID)", customerIDParameter);
        }
